 ...
 .addPanel(
    ...
    .addTarget(
      prometheus.target(
        ...
        legendFormat='{{datacenter}}-{{instance}} ({{cluster}})',
      )
    )
  )
  .addPanel(
  ...
  .addPanel(
    ...
    .addTarget(
      prometheus.target(
        ...
        legendFormat='memory {{memory}} - {{datacenter}}-{{instance}}',
      )
    )
  )
  .addPanel(
